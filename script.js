const app = {
    ...
    methods: {
        getObjekt() {
            ...
            const totalAmount = 15528;

            let randomObjekt = Math.floor((Math.random() * totalAmount) + 1)
            fetch(`https://kulturarvsdata.se/ksamsok/api?method=search&hitsPerPage=1&startRecord=${randomObjekt}&query=text=${searchText}+AND+thumbnailExists=j`,
